# Multilingual Comment Analyzer - SMA Sem 6 Project
...
So a Hindi review like *"yeh product bahut accha hai!"* becomes *"This product is very good!"* internally, and then gets scored as Positive. The original text is always shown, translation is just for the analysis step.
...
python analyze.py --text "yeh bahut accha hai!"   # single comment
...
- Metric cards with total comments, how many languages were found, and positive/negative/neutral counts
- A donut chart of sentiment distribution
- A bar chart of language breakdown
- A scatter plot of polarity vs subjectivity where every dot is one comment
